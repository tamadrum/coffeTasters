...
class WheelFlavor: UIView {
    ...
    override init(frame: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            escreveTexto(texto: "Retrogosto", centro:centro, raio:raio, angulo:112.5)
            escreveTexto(texto: "Limpo", centro:centro, raio:raio, angulo:135)
            escreveTexto(texto: "Encorpado", centro:centro, raio:raio, angulo:157.5)
            escreveTexto(texto: "Apetitoso", centro:centro, raio:raio, angulo:180)
...
//            desenhaImagem(imagem: "Retrogosto.png", context: context, centro:centro, raio:raio, angulo:112.5)
//            desenhaImagem(imagem: "Limpo.png", context: context, centro:centro, raio:raio, angulo:135)
//            desenhaImagem(imagem: "Encorpado.png", context: context, centro:centro, raio:raio, angulo:157.5)
//            desenhaImagem(imagem: "Apetitoso.png", context: context, centro:centro, raio:raio, angulo:180)
...
//            desenhaImagem(imagem: "Frutas Vermelhas.png", context: context, centro:centro, raio:raio, angulo:337.5)
    ...
    func desenhaGrafico (context: CGContext, canvas: CGRect, centro: CGPoint, raio: Int, flavor: Flavor, cor: UIColor) {
        ...
        let doce = getCoordenadas(centro: centro, raio: flavor.doce*raio/100,  angulo:90)
        let azedo = getCoordenadas(centro: centro, raio:flavor.azedo*raio/100, angulo:67.5)
        let floral = getCoordenadas(centro: centro, raio:flavor.floral*raio/100, angulo:45)
        let especiarias = getCoordenadas(centro: centro, raio:flavor.especiarias*raio/100, angulo:22.5)
        let salgado = getCoordenadas(centro: centro, raio:flavor.salgado*raio/100, angulo:0)
        let frutasVermelhas = getCoordenadas(centro: centro, raio:flavor.frutasVermelhas*raio/100, angulo:337.5)
        let frutasCitrico = getCoordenadas(centro: centro, raio:flavor.frutasCitrico*raio/100, angulo:315)
        let frutasCaroco = getCoordenadas(centro: centro, raio:flavor.frutasCaroco*raio/100, angulo:292.5)
        let chocolate = getCoordenadas(centro: centro, raio:flavor.chocolate*raio/100, angulo:270)
        let caramelo = getCoordenadas(centro: centro, raio:flavor.caramelo*raio/100, angulo:247.5)
        let defumado = getCoordenadas(centro: centro, raio:flavor.defumado*raio/100, angulo:225)
        let amargo = getCoordenadas(centro: centro, raio:flavor.amargo*raio/100, angulo:202.5)
        let apetitoso = getCoordenadas(centro: centro, raio:flavor.apetitoso*raio/100, angulo:180)
        let encorpado = getCoordenadas(centro: centro, raio:flavor.encorpado*raio/100, angulo:157.5)
        let limpo = getCoordenadas(centro: centro, raio:flavor.limpo*raio/100, angulo:135)
        let retrogosto = getCoordenadas(centro: centro, raio:flavor.retrogosto*raio/100, angulo:112.5)
        ...
        context.addLine(to: apetitoso)
        context.addLine(to: encorpado)
        context.addLine(to: limpo)
        context.addLine(to: retrogosto)
