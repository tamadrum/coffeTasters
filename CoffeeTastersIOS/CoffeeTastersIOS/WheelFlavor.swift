...
//        desenhar()
    ...
    func desenhaGrafico (context: CGContext, canvas: CGRect, centro: CGPoint, raio: Int, flavor: Flavor, cor: UIColor) {
        ...
        let herbal = getCoordenadas(centro: centro, raio:flavor.herbal*raio/100, angulo:180)
        let encorpado = getCoordenadas(centro: centro, raio:flavor.encorpado*raio/100, angulo:157.5)
        let cereais = getCoordenadas(centro: centro, raio:flavor.cereais*raio/100, angulo:135)
        let nozes = getCoordenadas(centro: centro, raio:flavor.nozes*raio/100, angulo:112.5)
